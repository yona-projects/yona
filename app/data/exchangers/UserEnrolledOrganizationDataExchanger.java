 ...
 * @author Keeun Baik
 */
public class UserEnrolledOrganizationDataExchanger extends DefaultExchanger {

    private static final String USER_ID = "user_id"; // BIGINT(19) NOT NULL
    private static final String ORGANIZATION_ID = "organization_id"; // BIGINT(19) NOT NULL
    ...
    public String getTable() {
        return "USER_ENROLLED_ORGANIZATION";
    }

    @Override
    protected String getInsertSql() {
        return "INSERT INTO USER_ENROLLED_ORGANIZATION (USER_ID, ORGANIZATION_ID) VALUES (?, ?)";
    }

    @Override
    protected String getSelectSql() {
        return "SELECT USER_ID, ORGANIZATION_ID FROM USER_ENROLLED_ORGANIZATION";
    }
