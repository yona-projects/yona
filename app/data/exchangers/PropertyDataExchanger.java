 ...
 * @author Yi EungJun
 */
public class PropertyDataExchanger extends DefaultExchanger {
    ...
    protected void setPreparedStatement(PreparedStatement ps, JsonNode node) throws SQLException {
        ...
        ps.setString(index++, node.get(VALUE).textValue());
    }
    ...
    protected void setNode(JsonGenerator generator, ResultSet rs) throws IOException, SQLException {
        ...
        putString(generator, VALUE, rs, index++);
    }
    ...
    protected String getInsertSql() {
        return "INSERT INTO PROPERTY (ID, NAME, VALUE) " + values(3);
    }

    @Override
    protected String getSelectSql() {
        return "SELECT ID, NAME, VALUE FROM PROPERTY";
    }
}
