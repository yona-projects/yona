 ...
 * @author Yi EungJun
 */
public class ProjectLabelDataExchanger extends DefaultExchanger {
    ...
    protected void setPreparedStatement(PreparedStatement ps, JsonNode node) throws SQLException {
        ...
        ps.setLong(index++, node.get(LABEL_ID).longValue());
    }
    ...
    protected void setNode(JsonGenerator generator, ResultSet rs) throws IOException, SQLException {
        ...
        putLong(generator, LABEL_ID, rs, index++);
    }
    ...
    protected String getInsertSql() {
        return "INSERT INTO PROJECT_LABEL (PROJECT_ID, LABEL_ID) " + values(2);
    }

    @Override
    protected String getSelectSql() {
        return "SELECT PROJECT_ID, LABEL_ID FROM PROJECT_LABEL";
    }
