 ...
 * @author Yi EungJun
 */
public class WatchDataExchanger extends DefaultExchanger {
    ...
    protected String getInsertSql() {
        return "INSERT INTO WATCH (ID, USER_ID, RESOURCE_TYPE, RESOURCE_ID) " + values(4);
    }

    @Override
    protected String getSelectSql() {
        return "SELECT ID, USER_ID, RESOURCE_TYPE, RESOURCE_ID FROM WATCH";
    }
}
