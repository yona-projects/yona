...
public class TaskApp extends Controller{
    ...
    private static class WebSocketServer {
        ...
        public static WebSocketConnector handelWebSocket(String userName, String projectName){
            ...
            WebSocketConnector webSocketConnector = new WebSocketConnector(userName, projectName, server);
    ...
    private static class WebSocketConnector extends WebSocket<String> implements Callback<String>, Callback0{
        ...
        public WebSocketConnector(String userName, String projectName, WebSocketServer webSocketServer) {
