...
ALTER TABLE posting_comment ADD COLUMN project_id bigint;
...
# --- !Downs
DROP INDEX IF EXISTS ix_issue_comment_project_id;
DROP INDEX IF EXISTS ix_posting_comment_project_id;
ALTER TABLE issue_comment DROP COLUMN project_id;
ALTER TABLE posting_comment DROP COLUMN project_id;

DROP INDEX IF EXISTS ix_issue_comment_author_id;
DROP INDEX IF EXISTS ix_posting_comment_author_id;
DROP INDEX IF EXISTS ix_pull_request_number;
DROP INDEX IF EXISTS ix_issue_author_id_state;
DROP INDEX IF EXISTS ix_issue_created_date;

DROP INDEX IF EXISTS ix_n4user_email;
DROP INDEX IF EXISTS uq_email_email_valid;
