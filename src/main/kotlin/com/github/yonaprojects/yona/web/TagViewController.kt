...
// yona-wiki P3-10 — BranchViewController와 정확히 같은 패턴의 git 태그 목록 화면
// (`/{owner}/{projectName}/tags`). yona에는 legacy 대응 화면이 없다(완전 신규 기능, P3-10 계획
// 문서의 범위 확정 섹션 참고) — BranchViewController.branches()의 접근 제어/에러 처리 구조를
// 그대로 재사용한다.
@Controller
class TagViewController(
    ...
    fun tags(
        ...
        // AccessControl.isAllowed()에서 매니저/조직관리자 전용)를 따른다(P3-10 계획 문서의 "권한"
        // 절 참고, BranchApiController.deleteBranch()와 동일한 근거).
