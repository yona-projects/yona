...
// RFC9728(Protected Resource Metadata) 응답. MCP 리소스 서버가 401 응답의 WWW-Authenticate
// 헤더로 이 위치를 가리켜야 하고(ResourceServerConfig 참고), 이 문서가 실제 인가 서버 위치/지원
// 스코프를 광고한다. `/mcp`가 리소스 경로이므로 RFC9728 §3.1에 따라
