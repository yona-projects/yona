...
source: docs/parity/tickets/p3-xx.md
created: YYYY-MM-DD
updated: YYYY-MM-DD
tags: [plan, p3]
---
...
왜 필요한가 — 문제·동기·현재 상태. `parity/tickets/p3-xx.md`의 원본 항목을 요약하되 중복 서술하지 않는다(링크로 대체).
...
프로젝트 관행([[../../parity/index]] 진행 규칙)에 따라 각 단계는 "실패하는 테스트 먼저 → RED 확인 → 최소 구현 → GREEN" 순으로 진행한다.
...
- 백로그 원본: [`docs/parity/tickets/p3-xx.md`](../../parity/tickets/p3-xx.md)
- 관련 계획: [[]]
- 관련 소스: `경로`
